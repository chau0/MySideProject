...
/**
 * This sample demonstrates the <b>low-level way to extract text</b> from a PDF
 * document.
 * <h3>Remarks</h3>
 * <p>
 * In order to obtain richer information about the extracted text content, see
 * the other available samples ({@link TextInfoExtractionSample},
 * {@link AdvancedTextExtractionSample}).
 * </p>
 * 
...
public class Main extends Sample {
	...
	public void run() {
		...
		try {
			...
			{
				String filePath = "test_data/selection.pdf";
				try {
