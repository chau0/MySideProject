...
public class ReplaceStream {
	public static final String SRC = "test_data/selection.pdf";
	public static final String DEST = "test_data/selection_modi.pdf";
	...
	public void manipulatePdf(String src, String dest) throws IOException, DocumentException {
		...
		if (object instanceof PRStream) {
			...
			stream.setData(new String(data).replace("ÉäÉÇÅ[Ég", "remote").getBytes());
		}
