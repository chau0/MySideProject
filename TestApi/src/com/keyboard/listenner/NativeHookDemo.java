package com.keyboard.listenner;
 ...
 */
public class NativeHookDemo extends JFrame implements ActionListener, ItemListener, NativeKeyListener,
		...
		if (item == menuItemEnable) {
			try {
				...
				if (e.getStateChange() == ItemEvent.SELECTED) {
					// Initialize native hook. This is done on window open
					// because the
					// listener requires the txtEventInfo object to be
					// constructed.
			...
			// Set enable/disable the sub-menus based on the enable menu item's
			// state.
